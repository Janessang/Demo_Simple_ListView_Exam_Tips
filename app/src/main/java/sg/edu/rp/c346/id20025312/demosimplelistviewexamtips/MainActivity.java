package sg.edu.rp.c346.id20025312.demosimplelistviewexamtips;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        examTipsArray[0] = ("Don't just read the code, " +
                "code it as much as possible during each practical session");
